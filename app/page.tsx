...
export default async function HomePage() {
  ...
  return (
    <main>
      <section className="border-b border-black/10 bg-gradient-to-b from-white to-slate-50 py-14 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 grid items-center gap-8 md:grid-cols-2">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="#listen" className="inline-flex items-center gap-2 rounded-full bg-black px-5 py-3 text-white hover:bg-black/90">
                Listen Live
              </a>
              <a href="/winchester-now" className="inline-flex items-center gap-2 rounded-full border px-5 py-3">
                Winchester Now
              </a>
            </div>
            <p className="mt-4 text-sm text-black/60">Charity No. 1160752</p>
          </div>
